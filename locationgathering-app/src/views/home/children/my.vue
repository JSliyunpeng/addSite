<template>
  <div class="my">
    <div class="user">
      <img class="user_face" v-if="person.avatar" :src="process_env+avatar" alt>
      <div v-else class="user_face"></div>
      <div class="box">
        <p class="user_name">{{person.name}}</p>
        <p class="user_id">{{person.account}}</p>
      </div>
    </div>
    <div class="lists">
  ...
  export default {
    ...
    methods: {
      loginOut() {
        ...
        // sessionStorage.setItem('userView','')
      }
    },
    created() {
    ...
    mounted() {
      this.person=this.$store.state.userView
      console.log('this.person',this.person)
      console.log('this.$store.state.userView',this.$store.state.userView)
    }
  };
</script>
